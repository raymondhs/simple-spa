...
void TestCallsTable::testStmt(){
	...
	CPPUNIT_ASSERT(call->stmtCallsProc(3,1));
	CPPUNIT_ASSERT(call->stmtCallsProc(3,2));
	CPPUNIT_ASSERT(call->stmtCallsProc(5,0));
	CPPUNIT_ASSERT(call->stmtCallsProc(6,1));
	result.insert(0);
	result.insert(1);
	result.insert(2);
	CPPUNIT_ASSERT(call->getProcCalledByStmt(3)==result);
	result.clear();
	result.insert(0);
	CPPUNIT_ASSERT(call->getProcCalledByStmt(5)==result);
	result.clear();
	result.insert(1);
	CPPUNIT_ASSERT(call->getProcCalledByStmt(6)==result);
	result.clear();
	result.insert(3);
	result.insert(5);
